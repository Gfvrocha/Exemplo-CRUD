...
public class FuncionarioController {
    ...
    public void atualizarFuncionario(Funcionario updateFuncionario) throws SQLException {

        Statement statement = objConnection.createStatement();
        String queryUpdate = "UPDATE funcionario SET sobrenome=? WHERE nome=?";
    ...
    public void cadastrarFuncionario(Funcionario newFuncionario) throws SQLException {
        ...
        System.out.println("Usuario cadastrato com sucesso");
